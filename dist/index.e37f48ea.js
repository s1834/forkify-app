...
const loadRecipe = async function(id) {
    try {
        ...
        console.log(`${err}\u{1F4A5}\u{1F4A5}`);
        throw err;
    }
};
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) return this._generateMarkupPreview(curPage + 1, curPage);
        // Last page
        if (curPage === numPages && numPages > 1) return this._generateMarkupPreview(curPage - 1, curPage);
        // Other page
        if (curPage < numPages) return [
            this._generateMarkupPreview(curPage - 1, curPage),
            this._generateMarkupPreview(curPage + 1, curPage)
        ].join("");
        // Page 1. and there are NO other pages
        return "";
    }
    _generateMarkupPreview(pageNum, curPage) {
      ...
      `;
        if (pageNum > curPage) return `<button data-goto="${pageNum}" class="btn--inline pagination__btn--next">
      <span>Page ${pageNum}</span>
      <svg class="search__icon">
        <use href="${0, _iconsSvgDefault.default}#icon-arrow-right"></use>
      </svg>
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./previewView.js":"1FDQ6"}]},["f0HGD","aenu9"], "aenu9", "parcelRequire6d3a")
